...
<tr>
		<td> Address Line: </td>
		<td> <input type ="text"  class="longPlease" name="AddressLine1"></input> </td>
</tr>
<tr>
		<td> City: </td>
		<td> <input type ="text"  class="longPlease" name = "City"></input> </td>
</tr>
<tr>
		<td> UserName: </td>
		<td> <input type ="text" class="longPlease"  name = "Username"></input> </td>
</tr>
<tr>
		<td> Password: </td>
		<td> <input type ="text"  class="longPlease" name = "Password"></input> </td>
</tr>
<tr>
<td></td>
<td>
