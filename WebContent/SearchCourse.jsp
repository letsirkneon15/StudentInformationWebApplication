...
<title>Create New Student</title>
	...
	<body>
		...
		<div id="main-containter">
			...
			<p><h1>Search for Course to Edit</h1></p>
			<hr>
<p>
...
<tr>
		<td> Course Name: </td>
		<td> <input type ="text" class="longPlease" name ="CourseName" ></input> </td>
<tr>
		<td> Course Description: </td>
		<td> <input type ="text"  class="longPlease" name="CourseDesc"></input> </td>
</tr>
<tr>
		<td> Date of Birth: </td>
